...
function SetMaintaskParam(selectedTrials) {
	...
	var demo_stim = { "stimulus": "244_2", "pronoun":"she", "desc": "Customer service assistant", "decisionThis": "Stole", "decisionOther": "Split", "pot": 1090.00, "index": -1 };
...
var phpParam = {
	...
	condfname: "servedConditions_exp10a.csv"};
var maintask = [];
var maintaskParam = [];
