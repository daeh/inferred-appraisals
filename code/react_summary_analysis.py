...
from iaa21_plot_pytorch_cvresults import get_iaf_names, format_iaf_labels_inlinechar, composite_emos_concord, composite_legend, composite_emos_summarybars, composite_Aweights, single_Aweights, new_emo_plot, new_emo_plot_iaf, composite_emos_concord_iaaonly, plotDM_handler
...
def plot_summary(res, n_tt_mixes=None, n_tt_folds=None, seed=None, outpath_base=None, cpar_path_full=None, cpar_path_priors=None, specificplayers_desc_shorthand=None, cialpha=None):
    ...
    # display_param = plotParam['display_param']
    # emotion_neworder = plotParam['emotion_neworder']
    ...
    composite_Aweights(learned_param_Amean=A_deltas_mean, emo_labels=emo_labels, iaf_labels=iaf_labels, fig_outpath=plotParam['figsOut'] / 'A-means-unfiltered.pdf', plotParam=plotParam)
    ...
    for outcome in plotParam['outcomes']:
        ...
        figsout.append(plotDM_handler(simmat, show_labels=False, show_colorbar=False, plotParam=plotParam, outpath=plotParam['figsOut'] / f'simmat-empir-generic-{outcome}.pdf'))
    ...
    for i_outcome, outcome in enumerate(Xshortdims['outcome']):
        ...
        figsout.append(plotDM_handler(simmat, label_rename_dict=iaf_labels_formatted_dict, show_labels=False, show_colorbar=False, plotParam=plotParam, outpath=plotParam['figsOut'] / f'simmat-iaf-generic-{outcome}.pdf'))
